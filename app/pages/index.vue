...
const homeTitle = computed(() =>
  `${siteInfo.value?.firstName} ${siteInfo.value?.lastName} | Senior Front-End Software Engineer`
)
  ...
  <NuxtLayout name="homepage">
    ...
    <div class="flex flex-col items-center px-6 sm:px-10 lg:px-10 xl:px-16 justify-start lg:justify-center pt-14 sm:pt-16 pb-6 lg:pt-0 lg:pb-0">
      ...
      <UiText as="p" class="text-sm text-center lg:text-[clamp(0.8rem,1vw,1rem)] font-light text-text-muted leading-tight mb-6 lg:mb-10">
        11+ years building Vue SPAs and enterprise design systems &middot; {{ siteInfo?.city }}, {{ siteInfo?.state }}
      </UiText>
