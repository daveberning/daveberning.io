---
title: Resume
description: "View the resume of Dave Berning, a Senior Front-End Software Engineer specializing in Vue, Nuxt, TypeScript, design systems, front-end architecture, accessibility, and mentoring."
resume:
  name: Dave Berning
  ...
  experience:
    - title: Senior Front-End Engineer I
      ...
      highlights:
        ...
        - Help define scalable front-end architecture, reusable component patterns, and shared coding standards.
  ...
  teaching:
    - title: Adjunct Professor, Web Design & Development
      ...
      highlights:
        ...
        - Continued mentoring students and early-career developers outside the classroom.
  writing:
    - title: Technical Writing & Publications
      organization: DigitalOcean, Frontend Weekly, and Bleeding Edge Press
      period: Selected publications
      summary: Wrote technical tutorials and books focused on front-end tooling, the Vue ecosystem, and practical workflow patterns for developers.
      highlights:
        - Vue.js and the broader Vue ecosystem
        - Nuxt.js and server-side rendering
        - TypeScript with Vue single-file components
